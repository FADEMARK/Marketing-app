...
const DEFAULT_TEMPLATE = `Eres un fotógrafo publicitario senior especializado en fotografía de alto impacto para campañas de redes sociales. {{modo_intro}} Debe verse como una fotografía tomada por un fotógrafo profesional de agencia, no como una plantilla básica ni un banco de imágenes genérico. Fotorrealista, con buena iluminación y composición moderna — NO un ícono plano, NO un clipart, NO una ilustración vectorial genérica tipo stock, NO un dibujo de caricatura.

Nombre del negocio (solo para tu contexto, NO lo escribas en la imagen): {{nombre_negocio}}.
Giro del negocio: {{giro_negocio}}.
Concepto/mensaje de la publicación (para ambientar la escena — de qué trata la promoción — pero NO lo escribas como texto): "{{mensaje_clave}}".
